        ...
        <div class="row">
          ...
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h1>Absensi Genpi Dumai</h1>
              <p>Website ini berfungsi sebagai absensi anggota dan sebagai sistem informasi anggota Genpi Dumai.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">Risky Ramadhan  </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">0838-0215-6458</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title">Github</h3>
                <p class="card-feature__subtitle">hackkyy</p>
              </div>
            </div>
          </div>
        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Risky Ramadhan All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
				<div class="col-lg-4 col-md-12 text-center text-lg-right footer-social">
					<a href="https://www.facebook.com/profile.php?id=100040182053214&mibextid=ZbWKwL" target="_blank"><i class="fab fa-facebook-f"></i></a>
					<a href="https://github.com/hackkyy" target="_blank"><i class="fab fa-github"></i></a>
					<a href="https://www.linkedin.com/in/risky-ramadhan-14a123234/" target="_blank" ><i class="fab fa-linkedin" target="_blank"></i></a>
